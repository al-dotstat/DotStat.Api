...
) : IRequestHandler<FakeCommand, ErrorOr<bool>>
{
  public async Task<ErrorOr<bool>> Handle(FakeCommand request, CancellationToken cancellationToken)
  {
    ...
    if (newDevelopers.Length == 0)
    {
      ...
      {
      Developer.Create("LSR", "ЛСР", null),
      Developer.Create("TEN", "ТЕН", null),
      Developer.Create("Baza", "База", null),
      };
    ...
    if (newComplexes.Length == 0)
    {
      ...
      {
      Complex.Create("Zolotoy", "Золотой", "Современный жилой комплекс, расположенный в экологически чистом районе города. Комплекс включает несколько домов с закрытой территорией и подземным паркингом.", "ул. Малышева, 145", "56.8346", "60.5997", 72000, null, DateTime.Parse("2023-12-01"), districts[0].Id),
      Complex.Create("Tatishchev", "Татищев", "Уютный жилой комплекс в исторической части города. Предлагает разнообразие планировок и развитую инфраструктуру.", "ул. Татищева, 90", "56.8353", "60.5726", 45000, null, DateTime.Parse("2022-10-01"), districts[0].Id),
      Complex.Create("Akvamarin", "Аквамарин", "Элитный жилой комплекс с видом на реку Исеть. Комплекс оборудован фитнес-залом, бассейном и закрытой территорией.", "ул. Щорса, 102", "56.8129", "60.5884", 64000, null, DateTime.Parse("2024-06-01"), districts[1].Id),
      Complex.Create("Vysokiy bereg", "Высокий берег", "Многоэтажный комплекс с прекрасными видами на город. В шаговой доступности парки, школы и магазины.", "ул. Сулимова, 5", "56.8585", "60.6087", 54000, null, DateTime.Parse("2025-03-01"), districts[0].Id),
      Complex.Create("Yubileynyy", "Юбилейный", "Жилой комплекс в центре города с отличной транспортной доступностью. Включает детские площадки и зону отдыха.", "ул. Ленина, 25", "56.8430", "60.6123", 35000, null, DateTime.Parse("2023-08-01"), districts[1].Id),
      Complex.Create("Zelenyy bor", "Зеленый бор", "Комплекс, окруженный зеленью и соснами. Отличный выбор для тех, кто ценит тишину и спокойствие.", "ул. Репина, 12", "56.8189", "60.5556", 47000, null, DateTime.Parse("2022-09-01"), districts[1].Id),
      Complex.Create("Bliznetsy", "Близнецы", "Два современных многоэтажных дома с закрытой территорией и детскими площадками. Хорошее транспортное сообщение.", "ул. Радищева, 3", "56.8361", "60.6100", 59000, null, DateTime.Parse("2024-11-01"), districts[1].Id),
      Complex.Create("Izumrudnyy", "Изумрудный", "Комфорт-класс комплекс с квартирами улучшенной планировки и парковкой. Рядом торговый центр и метро.", "ул. Шейнкмана, 24", "56.8366", "60.6058", 62000, null, DateTime.Parse("2023-04-01"), districts[0].Id),
      Complex.Create("Svetlyy mir", "Светлый мир", "Один из самых ярких проектов города. Жилой комплекс с просторными квартирами и панорамными окнами.", "ул. Волгоградская, 30", "56.8111", "60.6309", 68000, null, DateTime.Parse("2023-07-01"), districts[0].Id),
      Complex.Create("Panorama", "Панорама", "Современный жилой комплекс с прекрасными видами на город. В комплексе предусмотрены коммерческие помещения.", "ул. Пальмиро Тольятти, 15", "56.8218", "60.6083", 54000, null, DateTime.Parse("2024-09-01"), districts[1].Id),
      Complex.Create("Kristall", "Кристалл", "Высококачественный жилой комплекс с дизайнерскими интерьерами и закрытой территорией.", "ул. Щорса, 50", "56.8104", "60.5857", 73000, null, DateTime.Parse("2023-05-01"), districts[0].Id),
      Complex.Create("Solnechnyy", "Солнечный", "Комплекс в динамично развивающемся районе. На территории предусмотрены магазины, аптеки и зоны отдыха.", "ул. Щорса, 101", "56.8166", "60.6045", 49000, null, DateTime.Parse("2025-01-01"), districts[1].Id),
      Complex.Create("Vershina", "Вершина", "Жилой комплекс премиум-класса с потрясающими видами на город. Подземная парковка и развитая инфраструктура.", "ул. Луначарского, 48", "56.8358", "60.6027", 85000, null, DateTime.Parse("2023-10-01"), districts[1].Id),
      Complex.Create("Sapphire", "Сапфир", "Ультрасовременный жилой комплекс с квартирами различных планировок и панорамными окнами. Подземная парковка.", "ул. Краснолесья, 123", "56.8321", "60.5904", 61000, null, DateTime.Parse("2024-03-01"), districts[0].Id),
      Complex.Create("Severnoe siyaniye", "Северное сияние", "Жилой комплекс с квартирами бизнес-класса. На территории предусмотрены зоны отдыха и подземная парковка.", "ул. Академика Шварца, 31", "56.8329", "60.6261", 74000, null, DateTime.Parse("2024-10-01"), districts[0].Id),
      };
